 ...
 */
export var WeightOperationType;
(function (WeightOperationType) {
    /**
     * @generated from protobuf enum value: ZEROFY = 0;
     */
    WeightOperationType[WeightOperationType["ZEROFY"] = 0] = "ZEROFY";
    /**
     * @generated from protobuf enum value: REINITIALIZE = 1;
     */
    WeightOperationType[WeightOperationType["REINITIALIZE"] = 1] = "REINITIALIZE";
    /**
     * @generated from protobuf enum value: FREEZE = 2;
     */
    WeightOperationType[WeightOperationType["FREEZE"] = 2] = "FREEZE";
    /**
     * @generated from protobuf enum value: UNFREEZE = 11;
     */
    WeightOperationType[WeightOperationType["UNFREEZE"] = 11] = "UNFREEZE";
    /**
     * @generated from protobuf enum value: FREEZE_BIAS = 3;
     */
    WeightOperationType[WeightOperationType["FREEZE_BIAS"] = 3] = "FREEZE_BIAS";
    /**
     * @generated from protobuf enum value: FREEZE_INCOMING = 4;
     */
    WeightOperationType[WeightOperationType["FREEZE_INCOMING"] = 4] = "FREEZE_INCOMING";
    /**
     * @generated from protobuf enum value: OVERRIDE_WEIGHTS = 5;
     */
    WeightOperationType[WeightOperationType["OVERRIDE_WEIGHTS"] = 5] = "OVERRIDE_WEIGHTS";
    /**
     * @generated from protobuf enum value: OVERIIDE_BIASSES = 8;
     */
    WeightOperationType[WeightOperationType["OVERIIDE_BIASSES"] = 8] = "OVERIIDE_BIASSES";
    /**
     * @generated from protobuf enum value: CHANGE_LEARNING_RATE = 6;
     */
    WeightOperationType[WeightOperationType["CHANGE_LEARNING_RATE"] = 6] = "CHANGE_LEARNING_RATE";
    /**
     * @generated from protobuf enum value: SORT_BY_STAT = 7;
     */
    WeightOperationType[WeightOperationType["SORT_BY_STAT"] = 7] = "SORT_BY_STAT";
    /**
     * @generated from protobuf enum value: REMOVE_NEURONS = 9;
     */
    WeightOperationType[WeightOperationType["REMOVE_NEURONS"] = 9] = "REMOVE_NEURONS";
    /**
     * @generated from protobuf enum value: ADD_NEURONS = 10;
     */
    WeightOperationType[WeightOperationType["ADD_NEURONS"] = 10] = "ADD_NEURONS";
})(WeightOperationType || (WeightOperationType = {}));
/**
 * @generated from protobuf enum ZerofyPredicate
 */
export var ZerofyPredicate;
(function (ZerofyPredicate) {
    /**
     * @generated from protobuf enum value: ZEROFY_PREDICATE_NONE = 0;
     */
    ZerofyPredicate[ZerofyPredicate["NONE"] = 0] = "NONE";
    /**
     * @generated from protobuf enum value: ZEROFY_PREDICATE_WITH_FROZEN = 1;
     */
    ZerofyPredicate[ZerofyPredicate["WITH_FROZEN"] = 1] = "WITH_FROZEN";
    /**
     * @generated from protobuf enum value: ZEROFY_PREDICATE_WITH_OLDER = 2;
     */
    ZerofyPredicate[ZerofyPredicate["WITH_OLDER"] = 2] = "WITH_OLDER";
})(ZerofyPredicate || (ZerofyPredicate = {}));
...
// @generated message type with reflection information, may provide speed optimized methods
class NeuronId$Type extends MessageType {
    constructor() {
        super("NeuronId", [
...
// @generated message type with reflection information, may provide speed optimized methods
class NeuronConnection$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class WeightOperation$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class WeightsOperationRequest$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class WeightsOperationResponse$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class HyperParameters$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class MetricsStatus$Type extends MessageType {
    constructor() {
        super("MetricsStatus", [
...
// @generated message type with reflection information, may provide speed optimized methods
class AnnotatStatus$Type extends MessageType {
    constructor() {
        super("AnnotatStatus", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
// @generated message type with reflection information, may provide speed optimized methods
class TrainingStatusEx$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class HyperParameterCommand$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class DenySamplesOperation$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class LoadCheckpointOperation$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class TrainerCommand$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class HyperParameterDesc$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class NeuronStatistics$Type extends MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of globalThis.Object.keys(message.incomingLearningRate))
            writer.tag(8, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Bit32).float(message.incomingLearningRate[k]).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class LayerRepresentation$Type extends MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of globalThis.Object.keys(message.perNeuronLearningRates))
            writer.tag(8, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Bit32).float(message.perNeuronLearningRates[k]).join();
        ...
        for (let k of globalThis.Object.keys(message.perIncomingNeuronLearningRates))
            writer.tag(9, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Bit32).float(message.perIncomingNeuronLearningRates[k]).join();
...
// @generated message type with reflection information, may provide speed optimized methods
class ActivationRequest$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class ActivationMap$Type extends MessageType {
    constructor() {
        super("ActivationMap", [
...
// @generated message type with reflection information, may provide speed optimized methods
class ActivationResponse$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class TaskField$Type extends MessageType {
    constructor() {
        super("TaskField", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
// @generated message type with reflection information, may provide speed optimized methods
class SampleStatistics$Type extends MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of globalThis.Object.keys(message.sampleLabel))
            writer.tag(1, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Varint).int32(message.sampleLabel[k]).join();
        /* map<int32, int32> sample_prediction = 2; */
        for (let k of globalThis.Object.keys(message.samplePrediction))
            writer.tag(2, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Varint).int32(message.samplePrediction[k]).join();
        /* map<int32, float> sample_last_loss = 3; */
        for (let k of globalThis.Object.keys(message.sampleLastLoss))
            writer.tag(3, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Bit32).float(message.sampleLastLoss[k]).join();
        /* map<int32, int32> sample_encounters = 4; */
        for (let k of globalThis.Object.keys(message.sampleEncounters))
            writer.tag(4, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Varint).int32(message.sampleEncounters[k]).join();
        /* map<int32, bool> sample_discarded = 5; */
        for (let k of globalThis.Object.keys(message.sampleDiscarded))
            writer.tag(5, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Varint).bool(message.sampleDiscarded[k]).join();
...
// @generated message type with reflection information, may provide speed optimized methods
class SampleRequest$Type extends MessageType {
    constructor() {
        super("SampleRequest", [
...
// @generated message type with reflection information, may provide speed optimized methods
class SampleRequestResponse$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class BatchSampleRequest$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class BatchSampleResponse$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class WeigthsRequest$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class WeightsResponse$Type extends MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of globalThis.Object.keys(message.incomingLearningRates))
            writer.tag(10, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Bit32).float(message.incomingLearningRates[k]).join();
        /* bool success = 11; */
        if (message.success !== false)
