import type { JsonObject, JsonValue } from "@protobuf-ts/runtime/build/types/json-typings";
import type { JsonReadOptions } from "@protobuf-ts/runtime/build/types/json-format-contract";
import type { EnumInfo } from "@protobuf-ts/runtime/build/types/reflection-info";
import { LongType, PartialMessageInfo, ScalarType } from "@protobuf-ts/runtime/build/types/reflection-info";
import type { UnknownEnum, UnknownScalar } from "@protobuf-ts/runtime/build/types/unknown-types";
/**
