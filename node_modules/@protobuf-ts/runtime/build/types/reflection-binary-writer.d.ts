import type { BinaryWriteOptions, IBinaryWriter } from "@protobuf-ts/runtime/build/types/binary-format-contract";
import { WireType } from "@protobuf-ts/runtime/build/types/binary-format-contract";
import type { FieldInfo } from "@protobuf-ts/runtime/build/types/reflection-info";
import { PartialMessageInfo, ScalarType } from "@protobuf-ts/runtime/build/types/reflection-info";
import type { IMessageType } from "@protobuf-ts/runtime/build/types/message-type-contract";
/**
