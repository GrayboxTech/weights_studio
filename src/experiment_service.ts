...
/**
 * @generated from protobuf message DatasetManipulationRequest
 */
export interface DatasetManipulationRequest {
    /**
...
/**
 * @generated from protobuf message DatasetManipulationResponse
 */
export interface DatasetManipulationResponse {
    /**
     * @generated from protobuf field: bool success = 1
     */
    success: boolean;
...
/**
 * @generated from protobuf message SliceDatasetRequest
 */
export interface SliceDatasetRequest {
    /**
     * @generated from protobuf field: int32 start_pivot_index = 1
     */
    startPivotIndex: number;
    /**
     * @generated from protobuf field: int32 number_of_samples = 2
     */
...
// @generated message type with reflection information, may provide speed optimized methods
class DatasetManipulationRequest$Type extends MessageType<DatasetManipulationRequest> {
    constructor() {
        super("DatasetManipulationRequest", [
            { no: 1, name: "query", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<DatasetManipulationRequest>): DatasetManipulationRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.query = "";
        if (value !== undefined)
            reflectionMergePartial<DatasetManipulationRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DatasetManipulationRequest): DatasetManipulationRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DatasetManipulationRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string query = 1; */
        if (message.query !== "")
...
/**
 * @generated MessageType for protobuf message DatasetManipulationRequest
 */
export const DatasetManipulationRequest = new DatasetManipulationRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DatasetManipulationResponse$Type extends MessageType<DatasetManipulationResponse> {
    constructor() {
        super("DatasetManipulationResponse", [
            { no: 1, name: "success", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "message", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<DatasetManipulationResponse>): DatasetManipulationResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.success = false;
        message.message = "";
        if (value !== undefined)
            reflectionMergePartial<DatasetManipulationResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DatasetManipulationResponse): DatasetManipulationResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DatasetManipulationResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* string message = 2; */
...
/**
 * @generated MessageType for protobuf message DatasetManipulationResponse
 */
export const DatasetManipulationResponse = new DatasetManipulationResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SliceDatasetRequest$Type extends MessageType<SliceDatasetRequest> {
    constructor() {
        super("SliceDatasetRequest", [
            { no: 1, name: "start_pivot_index", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "number_of_samples", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<SliceDatasetRequest>): SliceDatasetRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.startPivotIndex = 0;
        message.numberOfSamples = 0;
        if (value !== undefined)
            reflectionMergePartial<SliceDatasetRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SliceDatasetRequest): SliceDatasetRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* int32 start_pivot_index */ 1:
                    message.startPivotIndex = reader.int32();
                    break;
                case /* int32 number_of_samples */ 2:
    ...
    internalBinaryWrite(message: SliceDatasetRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 start_pivot_index = 1; */
        if (message.startPivotIndex !== 0)
            writer.tag(1, WireType.Varint).int32(message.startPivotIndex);
        /* int32 number_of_samples = 2; */
        if (message.numberOfSamples !== 0)
            writer.tag(2, WireType.Varint).int32(message.numberOfSamples);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message SliceDatasetRequest
 */
export const SliceDatasetRequest = new SliceDatasetRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
